...
nsprsBfrMet = (ncells-2)*(nsprsInACell) + 2 + 1*(NAEC_apcl+1) + 1*(NAEC_bsal+1) + (1) -8 #(1) for VF spring
...
stressScaleA = 0.71 #0.21
stressScaleS = 2.40 #0.87
...
do for [gnuStep=1:gnuStepMax]{
   ...
   print nstrtLp,nend,gnuStep,"val"
