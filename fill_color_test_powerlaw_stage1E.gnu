...
N_iter = 84 #21 #111 #187

#411#96#367#144#84#48#139#831#286#38#45#26#35#46#14#399#44#47#388#224#56#57#28
...
stressScaleA = 0.41 #0.41 #0.71 #0.21 #0.58 #1.121 #0.49 #0.28 #0.33 #0.37 #0.37
stressScaleS = 2.30 #2.17 #2.21 #0.87 #2.33 #2.93#2.09#0.87#1.05#1.06#1.01 #1.51
...
do for [n=nstrt:nend]{
   ...
   if (nodeInsrtdOrNot==0) {
      datafileArea = datadir.sprintf('BeginStgAddCell_AW%03d.dat',n)
      datafileSpr  = datadir.sprintf('BeginStgAddCell_SW%03d.dat',n)}
         
   if (nodeInsrtdOrNot==1) {
      datafileArea = datadir.sprintf('NI_modelInitiatnAW%04d.dat',n)
      datafileSpr  = datadir.sprintf('NI_modelInitiatnSW%04d.dat',n)}   
   ...
   outputfile=sprintf('Exp0_%04d.eps',n)  # eps, not gif 
